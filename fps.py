...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="Test RDSETR model performance.")
    parser.add_argument('--weights', type=str, default='/root/autodl-tmp/my_rtdetr/r18_dcnv2_msa_ema3_adown(640)/weights/best.pt', help='trained weights path')
    ...
    parser.add_argument('--warmup', default=100, type=int, help='warmup iterations')
    parser.add_argument('--testtime', default=500, type=int, help='test iterations for latency')
