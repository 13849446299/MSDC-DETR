...
class RTDETRDetectionModel(DetectionModel):
    ...
    def __init__(self, cfg='ultralytics/cfg/models/my_models/r18_Dcnv2_msa_Adown_ReN.yaml', ch=3, nc=None, verbose=True):
        """
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in (Classify, Conv, ConvTranspose, GhostConv, Bottleneck, GhostBottleneck, SPP, SPPF, DWConv, Focus,
                 ...
                 Blocks, ConvNormLayer,nn.Conv2d,
                 RepNCSPELAN4, RepNCSPELAN4_high, ADown,):
            c1, c2 = ch[f], args[0]
            ...
            if m in (BottleneckCSP, C1, C2, C2f, C3, C3TR, C3Ghost, C3x, RepC3, Blocks,
                     RepNCSPELAN4, RepNCSPELAN4_high):
                args.insert(2, n)  # number of repeats
                n = 1
                             
        elif m in { CA, EMA, MultiDilatelocalAttention,
                 MPCA,MSCAAttention,MSCASpatialAttention}:
            c2 = ch[f]
            args = [c2, *args]
        ...
        elif m in { SwinTransformer, revcol_small, revcol_tiny,
                   revcol_base, revcol_xlarge, revcol_large,
                   }:
            m = m(*args)
